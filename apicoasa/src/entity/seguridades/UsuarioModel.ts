import { Entity, PrimaryColumn, Column, ManyToOne, Unique,PrimaryGeneratedColumn,OneToMany, Generated} from "typeorm";
...
export class seguridades_usuario {
   ...
   // @IsNotEmptyObject()
    ...
    @OneToMany(() => seguridades_usuario_role, userole => userole.secuencial_usuario, { cascade: true })
    userole: seguridades_usuario_role[];

    @OneToMany(() => mando_integral_usuario_plan_estrategico, usuarioestra => usuarioestra.secuencial_usuario, { cascade: true })
